...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url();?>design/src/plugins/datatables/css/dataTables.bootstrap4.min.css">
	<link rel="stylesheet" type="text/css" href="<?=base_url();?>design/src/plugins/datatables/css/responsive.bootstrap4.min.css">
	...
	<div class="header">
		...
		<div class="header-right">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								<li>
									<a href="#">
										<img src="<?=base_url();?>design/vendors/images/img.jpg" alt="">
										<h3>John Doe</h3>
								...
								<li>
									<a href="#">
										<img src="<?=base_url();?>design/vendors/images/photo1.jpg" alt="">
										<h3>Lea R. Frith</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="<?=base_url();?>design/vendors/images/photo2.jpg" alt="">
								...
								<li>
									<a href="#">
										<img src="<?=base_url();?>design/vendors/images/photo3.jpg" alt="">
										<h3>John Doe</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="<?=base_url();?>design/vendors/images/photo4.jpg" alt="">
			...
			<div class="github-link">
				<a href="https://github.com/dropways/deskapp" target="_blank"><img src="<?=base_url();?>design/vendors/images/github.svg" alt=""></a>
			</div>
		</div>
	</div>